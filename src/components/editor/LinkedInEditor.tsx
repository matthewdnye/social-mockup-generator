...
export function LinkedInEditor() {
  ...
  React.useEffect(() => {
    if (!author.headline) {
      setAuthor({ headline: 'Senior Software Engineer at Tech Company' })
    }
    if (!author.connectionDegree) {
      setAuthor({ connectionDegree: '1st' })
    }
  }, [author.headline, author.connectionDegree, setAuthor])
    ...
    <div className="space-y-6 overflow-y-auto p-6">
      <div>
        ...
        <p className="text-sm text-gray-600">
          Edit the LinkedIn post content and appearance
        </p>
      </div>

      {/* Theme Selector - LinkedIn only has light/dark */}
      <div className="space-y-3">
        ...
        <div className="flex gap-2">
          ...
          >
            <div className="mb-2 h-8 rounded border bg-[#1d2226] border-gray-700" />
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <Select
            value={author.connectionDegree || '1st'}
            onValueChange={(value: '1st' | '2nd' | '3rd') =>
              setAuthor({ connectionDegree: value })
            }
          >
            ...
            <SelectContent>
              {connectionDegreeOptions.map((option) => (
        ...
        <div className="flex items-center justify-between">
          <Label htmlFor="verified">LinkedIn Premium</Label>
          <Switch
            id="verified"
