...
const LikeIcon = ({ filled = false }: { filled?: boolean }) => (
  <svg viewBox="0 0 24 24" className="w-4 h-4">
    {filled ? (
      <path
        fill="#378FE9"
        d="M19.46 11l-3.91-3.91a7 7 0 01-1.69-2.74l-.49-1.47A2.76 2.76 0 0010.76 1 2.75 2.75 0 008 3.74v1.12a9.19 9.19 0 00.46 2.85L8.89 9H4.12A2.12 2.12 0 002 11.12a2.16 2.16 0 00.92 1.76 2.11 2.11 0 00-.92 1.74 2.14 2.14 0 001 1.8 2.12 2.12 0 00-.74 1.61A2.12 2.12 0 004.38 20h6.88a7 7 0 003.26-.8l1.77-.9a3.32 3.32 0 001.59-1.91l1.75-4.47a2.18 2.18 0 00-.17-2.02z"
      />
    ) : (
      <path
        fill="currentColor"
...
const SupportIcon = () => (
  <svg viewBox="0 0 24 24" className="w-4 h-4">
    <path
      fill="#715B8D"
      d="M12.26 21.22l-.26.27-.26-.27C6.61 16.54 3 12.91 3 9.5 3 6.42 5.42 4 8.5 4c1.74 0 3.41.81 4.5 2.09C14.09 4.81 15.76 4 17.5 4 20.58 4 23 6.42 23 9.5c0 3.41-3.61 7.04-8.74 11.72z"
    />
  </svg>
)
...
const LoveIcon = () => (
  <svg viewBox="0 0 24 24" className="w-4 h-4">
    <path
      fill="#DF704D"
      d="M12 21.638l-.846-.681C5.662 16.31 2 13.088 2 9.192 2 6.074 4.463 3.5 7.5 3.5c1.74 0 3.41.81 4.5 2.09C13.09 4.31 14.76 3.5 16.5 3.5 19.537 3.5 22 6.074 22 9.192c0 3.896-3.662 7.118-9.154 11.765l-.846.681z"
    />
  </svg>
)
...
const InsightfulIcon = () => (
  <svg viewBox="0 0 24 24" className="w-4 h-4">
    <path
      fill="#F5BB5C"
      d="M12 2a9 9 0 00-9 9 8.93 8.93 0 003.61 7.2l-.62 2.48A1.5 1.5 0 007.44 23h9.12a1.5 1.5 0 001.45-1.88l-.55-2.2A9 9 0 0012 2zm4.69 14.24l.8 3.2a.5.5 0 01-.49.62H6.94a.5.5 0 01-.48-.62l.87-3.48A6.92 6.92 0 015 11a7 7 0 1111.69 5.24z"
    />
  </svg>
)
...
const FunnyIcon = () => (
  <svg viewBox="0 0 24 24" className="w-4 h-4">
    <path
      fill="#63A7D4"
      d="M12 2a10 10 0 1010 10A10 10 0 0012 2zm0 18a8 8 0 118-8 8 8 0 01-8 8zm4-9a1.5 1.5 0 10-1.5-1.5A1.5 1.5 0 0016 11zm-4.5-1.5A1.5 1.5 0 108 11a1.5 1.5 0 003.5-1.5zM12 17.5c2.33 0 4.32-1.45 5.12-3.5H6.88c.8 2.05 2.79 3.5 5.12 3.5z"
    />
  </svg>
)
...
const CommentIcon = () => (
  <svg viewBox="0 0 24 24" className="w-5 h-5">
    <path
      fill="currentColor"
      d="M7 9h10v1H7zm0 4h7v-1H7zm16-2a9 9 0 01-9 9h-4l-4.28 4.28a1 1 0 01-1.71-.71V11a9 9 0 019-9 9 9 0 019 9zM9.46 19H14a7 7 0 000-14 7 7 0 00-7 7v7.46l1.29-1.29A1 1 0 019 19a.37.37 0 00.46 0z"
    />
  </svg>
)
...
const RepostIcon = () => (
  <svg viewBox="0 0 24 24" className="w-5 h-5">
    <path
      fill="currentColor"
      d="M13.96 5H6c-1.1 0-2 .9-2 2v10l2-2V7h7.96l-2 2.03 1.41 1.41L17.79 6l-4.42-4.41L11.96 3l2 2zm4.04 14H11l2-2.03-1.41-1.41L7.17 20l4.42 4.41L13 22.96l-2-2H18c1.1 0 2-.9 2-2V9l-2 2v8z"
    />
  </svg>
)
...
const MoreIcon = () => (
  <svg viewBox="0 0 24 24" className="w-6 h-6">
    <path
      fill="currentColor"
      d="M14 12a2 2 0 11-4 0 2 2 0 014 0zm6 0a2 2 0 11-4 0 2 2 0 014 0zM8 12a2 2 0 11-4 0 2 2 0 014 0z"
    />
  </svg>
)
...
const GlobeIcon = () => (
  <svg viewBox="0 0 16 16" className="w-3 h-3">
    <path
      fill="currentColor"
      d="M8 1a7 7 0 107 7 7 7 0 00-7-7zM3 8a5 5 0 01.22-1.47l.28.27a1 1 0 00.71.29h.8A1.19 1.19 0 016 8.24l.11.85a1.19 1.19 0 01-1.19 1.35H4a5.05 5.05 0 01-1-2.44zm5 5a5.34 5.34 0 01-.57 0A1.18 1.18 0 016.24 12L6 11.13a1.19 1.19 0 01.29-1l.71-.7a1.19 1.19 0 01.84-.35h1.32A1.19 1.19 0 0110.35 10l.29.51a1.19 1.19 0 01-.26 1.44L9.07 13A5 5 0 018 13zm3.56-2.33a3.19 3.19 0 00.36-1.46A1.19 1.19 0 0011 8.44V8a1.18 1.18 0 011.24-1.18A5 5 0 0111.56 10.67z"
    />
  </svg>
)
...
const PremiumBadge = () => (
  <svg viewBox="0 0 16 16" className="w-4 h-4 ml-1">
    <path
      fill="#C37D16"
      d="M8 0a8 8 0 108 8 8 8 0 00-8-8zm2.63 11.31L8 10l-2.63 1.31.5-2.93-2.12-2.07 2.93-.43L8 3.25l1.32 2.63 2.93.43-2.12 2.07.5 2.93z"
    />
  </svg>
)
